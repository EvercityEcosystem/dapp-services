    ...
    <section>
      ...
      <div class="form-item form-line-label">
        <label>
          ...
          <span
            v-if="form.fields.promisee.error"
            class="input-msg"
          >Check if data correct, please.</span>
        </label>
        <input
    ...
    <section>
      ...
      <div class="form-item form-line-label">
        <label>
          ...
          <span
            v-if="form.fields.location.error"
            class="input-msg"
          >Check if data correct, please.</span>
        </label>
        <input
      ...
      <div class="form-item form-line-label">
        <label>
          ...
          <span
            v-if="form.fields.dateObject.error"
            class="input-msg"
          >Check if data correct, please.</span>
        </label>
        <flat-pickr
      ...
      <div class="form-item form-line-label">
        <label>
          {{$t('issuing.form.id')}}
          <span
            v-if="form.fields.id.error"
            class="input-msg"
          >Check if data correct, please.</span>
        </label>
        <input v-model="form.fields.id.value" :class="{ error: form.fields.id.error }" type="text" />
      </div>
      <div class="form-item">
