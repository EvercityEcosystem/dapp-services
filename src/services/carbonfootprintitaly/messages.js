export default {
  en: {
    ...
    rt_ghu: "GHG reduced (t CO<sup>2</sup>e)",
    ...
    rp_sector: "Sector",
    rp_credits: "Purchased credits (t CO<sup>2</sup>e)",
    ...
    cfonValue: "CFO (t CO<sub>2</sub>e)",
    cfpValue: "CFP (kg CO<sub>2</sub>e)",
    cfpnValue: "CFP (g CO<sub>2</sub>e/UD-UF; kg CO<sub>2</sub>e/UD-UF, t CO<sub>2</sub>e/UD-UF))",
